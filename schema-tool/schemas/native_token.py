...
native_token_id = SimpleField(
    "Token ID",
    ByteArray(38),
    "Identifier of the native token. Its derivation is defined in <a href='../TIP-0044/tip-0044.md#foundry-output'>TIP-44</a>.",
)
...
native_token = Schema(
    "Native Token",
    "A token that is stored natively on the ledger.",
    native_token_fields,
    tipReference=38,
)
...
NativeTokensCountField = SimpleField(
    "Native Tokens Count",
    UInt8(),
    "The number of different native tokens held by the output.",
)
